...
const Shortlisted = (props: Props) => {
      ...
      render: (_: any, val: any) => {
        return (
          <div className="flex gap-1 items-center">
            <Tooltip title="Move to Inteviewed">
              <>
                <Button
                  state="primary"
                  onClick={() => {
                    handleUpdate(val.id, "interveiwed");
                  }}
                >
                  <FaCheck />
                </Button>
  ...
  return (
    <div>
      <h4 className="text-2xl">SHORTLISTED</h4>
      <BreadCrumb items={BREADCRUMB_DATA.CONDIDATES_SHORTLISTED} />
      <div className="mt-6">
