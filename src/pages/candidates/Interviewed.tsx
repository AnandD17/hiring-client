...
const Interviewed = (props: Props) => {
      ...
      render: (_: any, val: any) => {
        return (
          <div className="flex gap-1 items-center">
            <Tooltip title="Move to Hired">
              <>
                <Button
                  state="primary"
                  onClick={() => {
                    handleUpdate(val.id, "hired");
                  }}
                >
                  <FaRegHandshake />
                </Button>
  ...
  return (
    <div>
      <h4 className="text-2xl">HIRED</h4>
      <BreadCrumb items={BREADCRUMB_DATA.CONDIDATES_HIRED} />
      <div className="mt-6">
